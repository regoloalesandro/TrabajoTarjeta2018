...
class Medioboleto extends  Tarjeta {
	...
	public function reducirSaldo($valor){
		...
		if($this->ultviaje['year'] == getdate( $this->tiempo->time() )['year'] && $this->ultviaje['mon'] == getdate( $this->tiempo->time() )['mon'] && $this->ultviaje['mday'] == getdate( $this->tiempo->time() )['mday']){
		...
		$this->ultviaje = getdate( $this->tiempo->time() );
